...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, file_path='lm_examples.pkl', block_size=512):
        ...
        if os.path.exists(cached_features_file) and not args.overwrite_cache:
            ...
            self.examples = pickle_load(file_path)
            pickle_save(self.examples, cached_features_file)
        else:
...
DEFAULT_PKL = 'lm_examples.pkl'
def main():
    parser = argparse.ArgumentParser()

    # Required parameters
    parser.add_argument(
        "--train_data_file", default=DEFAULT_PKL, type=str, required=False, help="The input training data file (a text file)."
    )
    parser.add_argument(
        "--output_dir",
        default='lm_logs/',
